...
const app_name: string = 'anthropic_claude_enterprise_add-on_for_splunk'.replaceAll("_", " ");
const repo_name: string = 'anthropic_claude_enterprise_add-on_for_splunk';
const app_descr: string = 'Ingest audit, usage, cost, and spend-limit data from an Anthropic Claude Enterprise organization into Splunk.';
